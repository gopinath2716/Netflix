...
function HomeScreen() {
  return (
    <div>
      <Nav />
      <Banner />
      <Row title="Netflix Orignal" isLargeRow fetchURL={userrequests.fetchNetflixOriginals}/>
      ...
      <Row title="Action movies" isLargeRow fetchURL={userrequests.fetchActionMovies}/>
      <Row title="Comedy Movies" isLargeRow fetchURL={userrequests.fetchComedyMovies}/>
      <Row title="Romantic Movies" isLargeRow fetchURL={userrequests.fetchRomanceMovies}/>
